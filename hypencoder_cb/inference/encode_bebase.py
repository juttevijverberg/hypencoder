...
from hypencoder_cb.modeling.hypencoder_bebase import (
...
class InferenceTextEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        # Allow "be_base" as an alias for the BE-base TextDualEncoder
        internal_model_type = (
            "text_dual_encoder" if model_type == "be_base" else model_type
        )
